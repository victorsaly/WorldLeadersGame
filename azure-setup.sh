...
echo -e "   💰 Azure OpenAI (GPT-4): ~\$150 (100K tokens/day)"
echo -e "   💰 Content Moderator: ~\$75 (50K requests/day)"
echo -e "   💰 Speech Services: ~\$50 (10K requests/day)"
echo -e "   💰 Total: ~\$275/month for moderate usage"
echo ""
